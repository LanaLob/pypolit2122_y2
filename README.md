...
| 7 | 15.04.2022 | Веб-скрапинг: запросы с помощью requests и парсинг html-кода с помощью bs4 | - [Задания](https://disk.yandex.ru/d/rgbS0ByiqLpZRQ) | [Домашнее задание 6](https://disk.yandex.ru/d/rC3rLQX9FoCFsQ) (опциональное) <br> *дедлайн: 25.03.2022* | Неделя 10. Скрейпинг: сбор ссылок с сайта  <br> Неделя 11. Подведение итогов|
| 8 | 22.04.2022 | Веб-скрапинг: автоматизация работы браузера с помощью Selenium WebDriver | TBA | [Домашнее задание 7](https://disk.yandex.ru/d/ufBFOW76T58zkg) (опциональное) <br> *дедлайн: 22.04.2022* | TBA |
